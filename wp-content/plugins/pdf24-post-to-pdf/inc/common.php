...
function pdf24Plugin_replaceLang($str, $count, $searchReplace = null) {
	...
	$l = 'https://' . (isset($pdf24Plugin['useLang']) ? $pdf24Plugin['useLang'] : 'en') . '.pdf24.org';
	$c = '<a href="'. $l .'" target="_blank" style="color:inherit;font-size:inherit;font:inherit;text:inherit">$0</a>';
	foreach(array('sendAsPDF', 'sendArticleAsPDF', 'sendArticlesAsPDF', 'downloadAsPDF', 'downloadArticleAsPDF', 'downloadArticlesAsPDF') as $v) {
		$e = '{lang_'. $v .'}';
